...
public class Solution6242Tests {
    private final Solution6242 solution6242 = new Solution6242();
    ...
    public void example1() {
        ...
        Assertions.assertEquals(expected, solution6242.closestNodes(root, queries));
    }

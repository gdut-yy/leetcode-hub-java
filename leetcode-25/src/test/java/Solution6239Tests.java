...
public class Solution6239Tests {
    private final Solution6239 solution6239 = new Solution6239();
    ...
    public void example1() {
        ...
        Assertions.assertArrayEquals(expected, solution6239.splitMessage(message, limit));
    }
    ...
    public void example6() {
        ...
        String fileName = "solution6239-example6-input.txt";

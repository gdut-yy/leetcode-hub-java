...
public class Solution6217Tests {
    private final Solution6217 solution6217 = new Solution6217();
    ...
    public void example1() {
        ...
        int[] target = {2, 14, 10};
        long expected = 2;
        Assertions.assertEquals(expected, solution6217.makeSimilar(nums, target));
    }

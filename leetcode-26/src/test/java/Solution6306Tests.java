...
public class Solution6306Tests {
    private final Solution6306 solution6306 = new Solution6306();
    ...
    public void example1() {
        ...
        int expected = 6;
        Assertions.assertEquals(expected, solution6306.findCrossingTime(n, k, time));
    }

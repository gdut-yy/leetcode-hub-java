...
public class Solution411Tests {
    private final Solution411 solution411 = new Solution411();
    ...
    public void example1() {
        ...
        String expected = "a4";
        Assertions.assertEquals(expected, solution411.minAbbreviation(target, dictionary));
    }

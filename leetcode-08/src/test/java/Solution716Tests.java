...
public class Solution716Tests {
    @Test
    public void example1() {
        Solution716.MaxStack stk = new Solution716.MaxStack();
    ...
    public void example2() throws Exception {
        ...
        // 165 / 166 个通过测试用例
        reflection(Solution716.MaxStack2.class, "solution716-example2-input.txt", "solution716-example2-output.txt");
    }
    ...
    public void example3() throws Exception {
        ...
        // 164 / 166 个通过测试用例
        reflection(Solution716.MaxStack2.class, "solution716-example3-input.txt", "solution716-example3-output.txt");
    }

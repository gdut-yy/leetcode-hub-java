...
public class Solution288Tests {
    private final Solution288 solution288 = new Solution288();

    @Test
    public void example1() {
        String[] dictionary = {"deer", "door", "cake", "card"};
        Solution288.ValidWordAbbr validWordAbbr = new Solution288.ValidWordAbbr(dictionary);

...
public class SolutionO52Tests {
    private final SolutionO52 solutionO52 = new SolutionO52();
    ...
    public void example1() {
        ...
        Assertions.assertEquals(expected, solutionO52.getIntersectionNode(headA, headB));
    }

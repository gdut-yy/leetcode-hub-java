...
public class Solution5936Tests {
    private final Solution5936 solution5936 = new Solution5936();

    @Test
    public void example1() {
        int[][] bombs = {{2, 1, 3}, {6, 1, 4}};
        int expected = 2;
        Assertions.assertEquals(expected, solution5936.maximumDetonation(bombs));
    }

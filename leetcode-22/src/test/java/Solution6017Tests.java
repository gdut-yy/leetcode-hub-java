...
public class Solution6017Tests {
    private final Solution6017 solution6017 = new Solution6017();
    ...
    public void example1() {
        ...
        int k = 2;
        long expected = 5;
        Assertions.assertEquals(expected, solution6017.minimalKSum(nums, k));
    }

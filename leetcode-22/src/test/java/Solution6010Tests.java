...
public class Solution6010Tests {
    private final Solution6010 solution6010 = new Solution6010();
    ...
    public void example1() {
        ...
        int totalTrips = 5;
        long expected = 3;
        Assertions.assertEquals(expected, solution6010.minimumTime(time, totalTrips));
    }

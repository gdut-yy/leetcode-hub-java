...
public class Solution364Tests {
    private final Solution364 solution364 = new Solution364();
    ...
    public void example1() {
        ...
        int expected = 8;
        Assertions.assertEquals(expected, solution364.depthSumInverse(nestedList));
    }

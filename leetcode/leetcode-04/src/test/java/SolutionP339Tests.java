...
public class SolutionP339Tests {
    private final SolutionP339 solutionP339 = new SolutionP339();
    ...
    public void example1() {
        ...
        int expected = 10;
        Assertions.assertEquals(expected, solutionP339.depthSum(nestedList));
    }

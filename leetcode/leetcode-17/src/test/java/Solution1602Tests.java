...
public class Solution1602Tests {
    private final Solution1602 solution1602 = new Solution1602();
    ...
    public void example1() {
        ...
        Assertions.assertTrue(UtUtils.assertJsonEquals(expected, solution1602.findNearestRightNode(root, u)));
    }
    ...
    public void example4() {
        ...
        Assertions.assertTrue(UtUtils.assertJsonEquals(expected.val, solution1602.findNearestRightNode(root, u).val));
    }
}

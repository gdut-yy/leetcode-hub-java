...
public class SolutionLCR171Tests {
    private final SolutionLCR171 solutionLCR171 = new SolutionLCR171();
    ...
    public void example1() {
        ...
        Assertions.assertEquals(expected, solutionLCR171.getIntersectionNode(headA, headB));
    }

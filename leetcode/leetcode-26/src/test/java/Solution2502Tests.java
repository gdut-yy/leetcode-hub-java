...
public class Solution2502Tests {
    ...
    public void example1() {
        ...
        Assertions.assertEquals(1, loc.freeMemory(2));
        ...
        Assertions.assertEquals(3, loc.freeMemory(1));
        ...
        Assertions.assertEquals(0, loc.freeMemory(7));
    }

    @Test
    public void example2() {
        // 初始化一个大小为 10 的内存数组，所有内存单元都是空闲的。
        Solution2502.Allocator2 loc = new Solution2502.Allocator2(10);

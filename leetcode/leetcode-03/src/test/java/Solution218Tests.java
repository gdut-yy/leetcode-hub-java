...
public class Solution218Tests {
    private final Solution218.V1 solution218_v1 = new Solution218.V1();
    private final Solution218.V2 solution218_v2 = new Solution218.V2();
    private final Solution218.V3 solution218_v3 = new Solution218.V3();
    ...
    public void example1() {
        ...
        Assertions.assertEquals(expected, solution218_v1.getSkyline(buildings));
        Assertions.assertEquals(expected, solution218_v2.getSkyline(buildings));
        Assertions.assertEquals(expected, solution218_v3.getSkyline(buildings));
    }

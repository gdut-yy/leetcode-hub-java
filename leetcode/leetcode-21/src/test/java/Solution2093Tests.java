...
public class Solution2093Tests {
    private final Solution2093 solution2093 = new Solution2093();
    ...
    public void example1() {
        ...
        int discounts = 1;
        int expected = 9;
        Assertions.assertEquals(expected, solution2093.minimumCost(n, highways, discounts));
    }

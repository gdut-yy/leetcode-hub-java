...
public class Solution1891Tests {
    private final Solution1891 solution1891 = new Solution1891();
    ...
    public void example1() {
        ...
        int k = 3;
        int expected = 5;
        Assertions.assertEquals(expected, solution1891.maxLength(ribbons, k));
    }

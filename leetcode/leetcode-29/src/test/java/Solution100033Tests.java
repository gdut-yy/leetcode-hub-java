...
public class Solution100033Tests {
    private final Solution100033 solution100033 = new Solution100033();
    ...
    public void example1() {
        ...
        int expected = 2;
        Assertions.assertEquals(expected, solution100033.maxNumberOfAlloys(n, k, budget, composition, stock, cost));
    }

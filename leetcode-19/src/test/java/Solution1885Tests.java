...
public class Solution1885Tests {
    private final Solution1885 solution1885 = new Solution1885();
    ...
    public void example1() {
        ...
        int[] nums2 = {1, 2, 1, 2};
        long expected = 1;
        Assertions.assertEquals(expected, solution1885.countPairs(nums1, nums2));
    }

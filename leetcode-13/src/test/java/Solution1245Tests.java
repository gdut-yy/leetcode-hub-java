...
public class Solution1245Tests {
    private final Solution1245 solution1245 = new Solution1245();

    @Test
    public void example1() {
        int[][] edges = UtUtils.stringToInts2("[[0,1],[0,2]]");
        int expected = 2;
        Assertions.assertEquals(expected, solution1245.treeDiameter(edges));
    }

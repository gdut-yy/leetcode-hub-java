...
public class Solution1231Tests {
    private final Solution1231 solution1231 = new Solution1231();
    ...
    public void example1() {
        ...
        int k = 5;
        int expected = 6;
        Assertions.assertEquals(expected, solution1231.maximizeSweetness(sweetness, k));
    }

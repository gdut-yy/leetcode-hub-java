...
public class Solution6029Tests {
    private final Solution6029 solution6029 = new Solution6029();
    ...
    public void example1() {
        ...
        Assertions.assertArrayEquals(expected, solution6029.maximumBobPoints(numArrows, aliceArrows));
    }

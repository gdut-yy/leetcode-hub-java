...
public class Solution6072Tests {
    private final Solution6072 solution6072 = new Solution6072();

    @Test
    public void example1() {
        int[][] grid = UtUtils.stringToInts2("[[23,17,15,3,20],[8,1,20,27,11],[9,4,6,2,21],[40,9,1,10,6],[22,7,4,5,3]]");
        int expected = 3;
        Assertions.assertEquals(expected, solution6072.maxTrailingZeros(grid));
    }

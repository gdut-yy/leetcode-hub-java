...
public class Solution505Tests {
    private final Solution505 solution505 = new Solution505();
    ...
    public void example1() {
        ...
        int[] destination = {4, 4};
        int expected = 12;
        Assertions.assertEquals(expected, solution505.shortestDistance(maze, start, destination));
    }
